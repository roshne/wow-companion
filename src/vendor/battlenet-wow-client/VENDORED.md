...
[`roshne/battlenet-api-research`](https://github.com/roshne/battlenet-api-research) (commit `321cc9d`).
...
(most capturable GET endpoints, as of `321cc9d`); the rest remain `unknown`. Captured schemas are
